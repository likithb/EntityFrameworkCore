...
namespace Microsoft.EntityFrameworkCore.TestUtilities
{
    public class DocumentDbTestStore : TestStore
    {
        ...
        private const string _remoteEndpoint = "https://localhost:8081";
        private const string _remoteKey = "C2y6yDjf5/R+ob0N8A7Cgv30VRDJIWEHLM+4QDU5DE2nQ9nDuVTqobD4b8mGGyPMbIZnqyMsEcaGQy67XIw/Jw==";
